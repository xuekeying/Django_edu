...
class Course(models.Model):
    course_org = models.ForeignKey(CourseOrg, verbose_name=u"课程结构", null=True, blank=True)
...
class Video(models.Model):
    ...
    learn_time = models.CharField(default="", max_length=20, verbose_name=u"学习时长（分钟数）")
